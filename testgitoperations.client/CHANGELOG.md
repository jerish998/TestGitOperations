...
- Create Angular project with ng: `ng new testgitoperations.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`testgitoperations.client.esproj`).
